...
public class StocksServiceTest {
	...
	static float GIN_FIX_DIV = 0.2f;

	
	
	public StocksServiceTest(String ticket, Trade[] trades, float stockPrice, float yield, float peRatio) {
		this.ticket = ticket;
		this.yield = yield;
	...
	public void setup() {
		...
		service = new StocksService(data);
	}
	...
	public void two_ticket_trades_are_recorded() {
		...
		service.recordTrade(otherTicket_trade);
